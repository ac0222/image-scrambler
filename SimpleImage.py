...
#### Extra stuff added by Adrian Cheung ####

# Converts from PIL Image class (flat) to rectangular format
def to_rectangle(image):
...
# Converts from rectangular format back to flat default
# PIL Image class
def to_flat(image):
    flat_pixels = []
    for row in image:
